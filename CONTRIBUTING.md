# Como contribuir com o Guia de Gulp
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique (quando o nome já não for autoexplicativo).
4. **Ordem:** dentro de cada seção, recursos em português e gratuitos vêm primeiro. Se o recurso é pago, diga isso na própria descrição (ex.: "curso pago da Alura").
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-gulp`).
2. Edite o `README.md`.
